...
for i in range(pop_size):
    particle = {'RF':np.random.randint(100,500), 'SVM':np.random.uniform(0.1,7.0), 'LogReg':[np.random.uniform(0.1,7.0),np.random.randint(10,1000)], 'KNN':np.random.randint(10,100)} #hyperparam
    ...
    for p in swarm:
        ...
        for clf in p[0].keys():
            if clf == 'LogReg':
                ...
                if newPosition < 10 :
                    print("Forest < 10")
                    p[0][clf] = np.random.randint(100,500)
                else:
                    p[0][clf] = newPosition
                ...
                if newPosition <5 :
                    ...
                    p[0][clf] = np.random.randint(20,100)
                else:
                    p[0][clf] = newPosition
